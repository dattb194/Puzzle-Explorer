...
namespace DG.Tweening
{
	...
	public static class DOTweenModuleUnityVersion
    {
        ...
        /// <summary>Tweens a Material's named texture offset property with the given ID_Editing to the given value.
        /// Also stores the material as the tween's target so it can be used for filtered operations</summary>
        /// <param name="endValue">The end value to reach</param>
        /// <param name="propertyID">The ID_Editing of the material property to tween (also called nameID in Unity's manual)</param>
        /// <param name="duration">The duration of the tween</param>
        ...
        /// <summary>Tweens a Material's named texture scale property with the given ID_Editing to the given value.
        /// Also stores the material as the tween's target so it can be used for filtered operations</summary>
        /// <param name="endValue">The end value to reach</param>
        /// <param name="propertyID">The ID_Editing of the material property to tween (also called nameID in Unity's manual)</param>
        /// <param name="duration">The duration of the tween</param>
